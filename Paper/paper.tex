...
\begin{figure*}[t]
  ...
  \caption{Left: AAA. Middle: BBB. Right: CCC.}
  \label{fig:tech}
\end{figure*}

\subsection{Implementation Details}

We will now discuss the implementation details of each of the systems that make up {\em Kimbee}.

\subsubsection{Game (Kimbee)}

[Game Implementation Details Here]
