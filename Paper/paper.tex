...
We will first describe the flow a typical user would take when using this application. The flow is split into two parts, one to describe the game the child or user would play and another to describe what the therapist would see after the child has played the game.
